...
def get_sims_by_bin(walk_df, agg='min'):
	...
	for _, row in tqdm(walk_df.iterrows(), total=len(walk_df)):
            try:
                    ...
                    bin_to_sim[bin_agg].append(sim)
            except Exception as e:
                    bin_to_sim['NA'].append(None)
	return(bin_to_sim)
	
a1_hop_sims = get_sims_by_bin(a1_hop_df, agg='max')
joblib.dump(a1_hop_sims, '1_hop_sims_agg_max')

a2_to_4_hop_sims = get_sims_by_bin(a2_to_4_hop_df, agg='max')
joblib.dump(a2_to_4_hop_sims, '2_to_4_hop_sims_ag_max')

a1_hop_sims = get_sims_by_bin(a1_hop_df)
joblib.dump(a1_hop_sims, '1_hop_sims_agg_min')

a2_to_4_hop_sims = get_sims_by_bin(a2_to_4_hop_df)
joblib.dump(a2_to_4_hop_sims, '2_to_4_hop_sims_ag_min')
