...
parser.add_argument("-M", "--model", help="model name such as allenai/specter, allenai/specter2 or malteos/scincl", 
...
# Added by Jamie Sun
try:
    os.chmod(nodefile, stat.S_IRWXU | stat.S_IRWXG | stat.S_IROTH)
    os.chmod(edgefile, stat.S_IRWXU | stat.S_IRWXG | stat.S_IROTH)
except:
    errors = errors+1
